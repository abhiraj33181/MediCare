        ...
        <div className='container mx-auto text-center'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center mb-12'>
                ...
                <Link href="/login/doctor">
                    <Button size='lg' variant='outline' className='cursor-pointer w-full border-blue-600 text-blue-600 hover:bg-blue-50 rounded-full px-8 py-2 text-lg'>
                        Login as Doctor
                    </Button>
                </Link>
            </div>
                ...
                <div className='container mx-auto px-4'>
                    <div className='flex justify-center items-center overflow-x-auto gap-6 pb-2 scrollbar-hide mx-auto'>
                        {healthcareCategories.map((category) => (
                            <button
                            key={category.id}
                            onClick={() => handleCatrgoryClick(category.title)}
